      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            <img src="https://i.ibb.co.com/Y73sQXp/glenn-carstens-peters-loa-TW2-Af-DYU-unsplash.jpg" alt="Product Management Strategies" className="h-40 w-full object-cover rounded-t-lg mb-4" />
          ...
          {/* Blog Post 2 */}
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            <img src="https://i.ibb.co.com/Y73sQXp/glenn-carstens-peters-loa-TW2-Af-DYU-unsplash.jpg" alt="Creating a Product Roadmap" className="h-40 w-full object-cover rounded-t-lg mb-4" />
          ...
          {/* Blog Post 3 */}
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            <img src="https://i.ibb.co.com/Y73sQXp/glenn-carstens-peters-loa-TW2-Af-DYU-unsplash.jpg" alt="Customer Feedback in Product Management" className="h-40 w-full object-cover rounded-t-lg mb-4" />
